...
console.log('%c 00 axios.defaults.baseURL', 'color:blue', axios.defaults.baseURL);
...
const Profiles = {
	...
	listActivities: (username, predicate) => request.get(`/profiles/${username}/aktivnosti?predicate=${predicate}`),
};
