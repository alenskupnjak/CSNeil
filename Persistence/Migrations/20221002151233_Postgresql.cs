    ...
    public partial class Postgresql : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivitiesTable", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityAttendees_ActivitiesTable_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "ActivitiesTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_ActivitiesTable_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "ActivitiesTable",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
